...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <section id="material" class="material">
        ...
        <div class="mb-3"></div>
          <h2>สินค้า</h2>
          <p>รวมสินค้า<span>อุปกรณ์</span></p>
        </div>
      ...
      <div class="container">
        <div class="row">
            <div class="col-sm-1 col-md-3 col-lg-3">
                <div class="card">
                    <img src="assets/img/equipment/ชุดช้อนตวง.png" class="card-img-top" alt="...">
                    <div class="card-body">
                    <h5 class="card-title">ชุดช้อนตวง</h5>
                    <p class="card-text">ชุดช้อนตวงสแตนเลส 4 ชิ้น 60 บาท</p>
            ...
            <div class="col-sm-1 col-md-3 col-lg-3">
                <div class="card">
                    <img src="assets/img/equipment/ตะกร้อมือสแตนเลสM.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">ตะกร้อมือสแตนเลส M</h5>
                        <p class="card-text">ตะกร้อมือสแตนเลส อย่างหนา ไซส์ M 80 บาท</p>
                        <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-1 col-md-3 col-lg-3">
                <div class="card">
                    <img src="assets/img/equipment/ตะกร้อมือสแตนเลสS.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">ตะกร้อมือสแตนเลส S</h5>
                        <p class="card-text">ตะกร้อมือสแตนเลส อย่างหนา ไซส์ S 65 บาท</p>
                        <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-1 col-md-3 col-lg-3">
                <div class="card">
                    <img src="assets/img/equipment/ตะแกรงพักเคลือบเทฟล่อนL.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">ตะแกรงพักเคลือบเทฟล่อน L</h5>
                        <p class="card-text">ตะแกรงพักเคลือบเทฟล่อน ไซส์ L 80 บาท</p>
                        <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-1 col-md-3 col-lg-3">
                <div class="card">
                    <img src="assets/img/equipment/ตะแกรงร่อนแป้ง.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">ตะแกรงร่อนแป้ง</h5>
                        <p class="card-text">ตะแกรงร่อนแป้งสแตนเลส 55 บาท</p>
                        <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-1 col-md-3 col-lg-3">
                <div class="card">
                    <img src="assets/img/equipment/ถ้วยตวงพลาสติก300ml.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">ถ้วยตวงพลาสติก</h5>
                        <p class="card-text">ถ้วยตวงพลาสติก ขนาด 300 ml 60 บาท </p>
                        <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-1 col-md-3 col-lg-3">
                <div class="card">
                    <img src="assets/img/equipment/ถ้วยตวงพลาสติก600ml.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">ถ้วยตวงพลาสติก</h5>
                        <p class="card-text">ถ้วยตวงพลาสติก ขนาด 600 ml 80 บาท </p>
                        <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-1 col-md-3 col-lg-3">
                <div class="card">
                    <img src="assets/img/equipment/เซ็ตถ้วยตวง.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">เซ็ตถ้วยตวง 5 ชิ้น</h5>
                        <p class="card-text">ชุดเซ็ตถ้วยตวงพลาสติก 5 ชิ้น (คละสี) 60 บาท</p>
                        <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                    </div>
                </div>
