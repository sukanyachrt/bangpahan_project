...
if ($rsorder['order_status'] == 1) {
    $order_status =    '<span class="badge rounded-pill bg-danger">รอชำระเงิน</span>';
} else if ($rsorder['order_status'] == 2) {
    $order_status =    '<span class="badge rounded-pill bg-warning">รอยืนยันการชำระเงิน</span>';
} else if ($rsorder['order_status'] == 3) {
    $order_status =   '<span class="badge rounded-pill bg-info">รอจัดส่ง</span>';
} else if ($rsorder['order_status'] == 4) {
    $order_status =    '<span class="badge rounded-pill bg-success">จัดส่งเรียบร้อยแล้ว</span>';
} else if ($rsorder['order_status'] == 0) {
    $order_status =  '<span class="badge rounded-pill bg-dark">ข้อมูลการชำระเงินไม่ถูกต้อง</span>';
}
?>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-0">รายละเอียดข้อมูลการชำระเงิน / <?= $order_status ?></h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <div class="text-center position-relative">
                                                            <div class="step-icon mx-auto bg-danger border rounded-circle d-flex align-items-center justify-content-center" style="width:50px;height:50px;">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="text-center position-relative">
                                                            <div class="step-icon mx-auto <?php if ($order_status >= 3) echo "bg-danger";
                                                                ...
                                                                <svg class="bi bi-truck text-white" fill="currentColor" height="25" viewbox="0 0 16 16" width="30" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div class="list-group  border  border-3 border-danger">
                                                                ...
                                                                ?>
                                                                    <a href="javascript:void(0);" class="list-group-item list-group-item-action text-center">
                                                                        <button class="btn btn-outline-warning m-2" onclick="confirmPayment('NO')">ข้อมูลการชำระไม่ถูกต้อง</button>
                                                                        <button class="btn btn-primary" onclick="confirmPayment('YES')"> <i class='bx bxs-edit text-white'></i> ยืนยันผลการชำระเงิน</button>
                                                                    </a>
                                                                <?php } ?>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <p class="mb-0"><?= $rsorder['customer_fname'] . " " . $rsorder['customer_lname'] ?></p>
                                                            <p class="my-1"><?= $rsorder['c_address'] ?></p>
                                                            <p class="mb-0 font-13"><?= $rsorder['customer_telephone'] ?></p>
                                                        </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        while ($result = $product->fetch_AssocData()) {
                                            $sumAllmoney += number_format($result['product_price'] * $result['order_qty'], 2);
                                                ...
                                                <div class="card-body">
                                                    <div class="row align-items-start">
                                                        ...
                                                        <div class="col-md-2 col-12 align-self-center overflow-hidden">
                                                            <div>
                                                                <h5 class="text-truncate font-size-18"><a href="#" class="text-dark">Price </a></h5>

                                                                <p class="mb-0 mt-1"><span class="fw-medium"><?= "฿" . $result['product_price'] ?></span></p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-12 align-self-center overflow-hidden">
                                                            <div>
                                                                <h5 class="text-truncate font-size-18"><a href="#" class="text-dark">Quantity </a></h5>

                                                                <p class="mb-0 mt-1"><span class="fw-medium"><?= $result['order_qty'] ?></span></p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-12 align-self-center overflow-hidden">
                                                            <div>
                                                                <h5 class="text-truncate font-size-18"><a href="#" class="text-dark">Total </a></h5>

                                                                <p class="mb-0 mt-1"><span class="fw-medium"> <?= "฿" . number_format($result['product_price'] * $result['order_qty'], 2) ?></span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12 text-center">
                                            <div class="d-grid gap-2 col-lg-6 mx-auto">
                                                <button class="btn btn-primary btn-lg" type="button" onclick="confirm(4)">
                                                    <i class='bx bxs-check-square text-white'></i>
...
<script>
    ...
    function confirm(status) {
        $.ajax({
            type: 'GET',
            url: "../../services/payment/data.php?v=updatestatus&id=<?php echo $_GET['id'] ?>&status=" + status,
