            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-0">ข้อมูลกลุ่มสินค้า</h4>
                                            ...
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center"> ชื่อกลุ่มสินค้า </th>
                                                        <th class="text-center"> สถานะ </th>
                                                        <th class="text-center">ประเภทสินค้า </th>
                                                        <th class="text-center"></th>
                                                    </tr>
                                                </thead>
                                                <tbody id="tbproductgroup">
...
<script>
    ...
    $("#search").on("keyup", function() {
        ...
        $("#tbproductgroup tr").filter(function() {
    ...
    function dataProducttype() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("tbproductgroup").innerHTML = this.responseText;

            }
        };
        xhttp.open("GET", "../../services/productgroup/tableProductgroup.php", true);
        xhttp.send();
    }
    ...
    function confirmDel_employ() {
        ...
        $.ajax({
            type: 'GET',
            url: "../../services/productgroup/data.php?v=updateProductgroupStatus&id=" + objId,
