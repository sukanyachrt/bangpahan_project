...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="mb-3"></div>
      <h2>สินค้า</h2>
      <p>รวมสินค้า<span>ผงฟู/ผงวุ้น/เจลาติน</span></p>
    </div>
    ...
    <div class="row">
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powder/นางเงือก ผงวุ้น.png" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">นางเงือก ผงวุ้น</h5>
                <p class="card-text">ผงวุ้น ตรานางเงือก AA (ซองเขียว) 25G 40 บาท</p>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powder/เจลาตินแผ่น.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">เจลิต้า เจลาตินแผ่น</h5>
                    <p class="card-text">เจลาติน Gelita Gelatin เจลิต้า เจลาตินแผ่น 20G (12 แผ่น) 63 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powder/แม็กกาแรต ครีม ออฟ.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">McGarrett Cream of Tartar</h5>
                    <p class="card-text">แม็กกาแรต ครีม ออฟ ทาร์ทาร์ 200g 115 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powder/แม็กกาแรต ผงฟู.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">McGarrett Baking Powder (ผงฟู)</h5>
                    <p class="card-text">แม็กกาแรต ผงฟู 300g 58 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powder/แม็กกาแรต ผงวุ้น.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">McGarrett Agar Agar Powder (ผงวุ้น)</h5>
                    <p class="card-text">แม็กกาแรต ผงวุ้น (อะการ์-อะการ์) 50g 100 บาท </p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powder/แม็กกาแรต เบคกิ้งโซดา.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">McGarrett Baking Soda (เบกกิ้งโซดา)</h5>
                    <p class="card-text">แม็กกาแรต เบคกิ้งโซดา 300g 28 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powder/แม็กกาแร็ต กรดซิตริกแอซิ.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">McGarrett Citric Acid</h5>
                    <p class="card-text">แม็กกาแรต กรดซิตริกแอซิด 100g 37 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powder/โทรศัพท์ ผงวุ้น.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">โทรศัพท์ ผงวุ้น</h5>
                    <p class="card-text">โทรศัพท์ ผงวุ้น 25g 35 บาท </p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
