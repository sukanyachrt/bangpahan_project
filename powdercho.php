...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="mb-3"></div>
      <h2>สินค้า</h2>
      <p>รวมสินค้า<span>ผงโกโก้</span></p>
    </div>
    ...
    <div class="row">
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powdercho/barry cacao 1kg.png" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">Barry Cocoa Powder Plein Arome 1kg</h5>
                <p class="card-text">ผงโกโก้ Barry Cocoa Powder Arome (Dark Brown#2) 1KG 540 บาท</p>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powdercho/barry cacao 250.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Barry Cocoa Powder Extra Brute 250kg</h5>
                    <p class="card-text">ผงโกโก้ Barry Cocoa Powder ExtraBrute (Dark Brown#3) 250G 165 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powdercho/barryผงช้อค.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Barry ผงช็อคโกแลต 31.7%</h5>
                    <p class="card-text">ผงโกโก้ Barry Chocolate Powder 31.7% 250G (แบ่งบรรจุ) 110 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powdercho/bensdrop.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Bensdorp Cocoa Powder</h5>
                    <p class="card-text">ผงโกโก้ Bensdorp Queen Anna Cocoa Powder เบนดร็อป ควีน 8KG 95 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powdercho/valrhona.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">ValrhonaCocoa Powder</h5>
                    <p class="card-text">ผงโกโก้ ValrhonaCocoa Powder 3KG 120 บาท </p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powdercho/vanhouten 250.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Van Houten Round DarkBrown</h5>
                    <p class="card-text">ผงโกโก้ Van Houten Round DarkBrown เบนดร็อป ควีน 8KG 95 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powdercho/vanhouten robust.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Van Houten Round Dark Brown</h5>
                    <p class="card-text">ผงโกโก้ Van Houten Round Dark Brown 1,070 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/powdercho/vanhouten round.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Van Houten Robust Red Cameroon</h5>
                    <p class="card-text">ผงโกโก้ Van Houten Robust Red Cameroon 490 บาท </p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
