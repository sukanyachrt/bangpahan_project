...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="mb-3"></div>
      <h2>สินค้า</h2>
      <p>รวมสินค้า<span>กลิ่นและสีผสมอาหาร</span></p>
    </div>
    ...
    <div class="row">
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/flavors-foodcoloring/กลิ่นวินเนอร์ วานิลลา.png" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">กลิ่น Winner วินเนอร์</h5>
                <p class="card-text">กลิ่นวานิลลา 60ML 27 บาท</p>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/flavors-foodcoloring/กลิ่นMcCormick วานินลา.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">กลิ่นMcCormick Imitation Vanilla</h5>
                    <p class="card-text">กลิ่นวานิลลา 60ML 125 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/flavors-foodcoloring/กลิ่นเบสท์ โอเดอร์.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">กลิ่นเบสท์ โอเดอร์</h5>
                    <p class="card-text">กลิ่นวานิลลาบัตเตอร์ 30 ML 20 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/flavors-foodcoloring/กลิ่นวินเนอร์ เนยนม.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">กลิ่นWinner วินเนอร์</h5>
                    <p class="card-text">กลิ่นนมเนย 60ML 27 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/flavors-foodcoloring/วินเนอร์ เขียว.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">สีผสมอาหารWinner วินเนอร์</h5>
                    <p class="card-text">สีน้ำ สีเขียวแอปเปิ้ล 28ML 15 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/flavors-foodcoloring/วินเนอร์ ฟ้า.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">สีผสมอาหารWinner วินเนอร์</h5>
                    <p class="card-text">สีน้ำ สีฟ้า 28ML 15 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/flavors-foodcoloring/วินเนอร์ สีเหลืองไข่.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">สีผสมอาหารWinner วินเนอร์</h5>
                    <p class="card-text">สีน้ำ สีเหลืองไข่ 28ML 15 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/flavors-foodcoloring/วินเนอร์ สีรชมพู.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">สีผสมอาหารWinner วินเนอร์</h5>
                    <p class="card-text">สีน้ำ สีชมพู 28ML 15 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
