  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a href="../projectYummy/index.php#hero">หน้าหลัก</a></li>
          ...
          <ul>
              <li class="dropdown"><a href="../projectYummy/index.php#product"><span>วัตถุดิบ</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
    ...
    <div class="row">
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/butter/มีลเมด ออริจิ.png" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">มิลเมด ออริจิ เนยจืด</h5>
                <p class="card-text">Mealmate Original Pure Unsalted Butter 1KL 350 บาท</p>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/butter/อะลาวรี่ คอมพาวด์.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">อะลาวรี่ คอมพาวด์ (จืด)</h5>
                    <p class="card-text">Allowrie Compound Unsalted Butter 1KL 235 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/butter/อะลาวรี่ เนยแท้.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">อะลาวรี่ เนยแท้จืด</h5>
                    <p class="card-text">Allowrie Unsalted Butter 400G 215 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/butter/อะลาวรี่ คอมพาวด์เนย.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">อะลาวรี่ คอมพาวด์ (เค็ม)</h5>
                    <p class="card-text">Allowrie Compound Salted Butter 1KL 235 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/butter/อิซิกนี่ เนยแท้ เนยจืด.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">อิซิกนี่ เนยแท้ เนยจืด</h5>
                    <p class="card-text">Isigny Butter Sheet A.O.P 1KL 795 บาท </p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/butter/แดรี่โกล์ด.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">แดรี่โกล์ด เอ็กซ์ตร้า</h5>
                    <p class="card-text">Dairy Gold Extra Salted Butter (แดรี่โกล์ด เอ็กซ์ตร้าเนยผสมไขมันเนย 38%) 1KL 180 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/butter/แอลเลเวียร์ เนยแท้.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Elle&Vire Extra Dry Butter</h5>
                    <p class="card-text">แอลเลเวียร์ เนยแท้ เนยจืด 1KL 745 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/butter/แอลเลเวียร์ เนยแท้เนยจืด.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">แอลเลเวียร์ เนยแท้จืด</h5>
                    <p class="card-text">Elle&Vire Gourmet Unsalted Butter 200G 150 บาท </p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
