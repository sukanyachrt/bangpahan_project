...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="mb-3"></div>
      <h2>สินค้า</h2>
      <p>รวมสินค้า<span>วิปปิ้งครีม</span></p>
    </div>
    ...
    <div class="row">
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/wripping/anchor whipping.png" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">Anchor Whipping Cream</h5>
                <p class="card-text">วิปปิ้งครีม Anchor Whipping Cream 1L 235 บาท</p>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/wripping/debic.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Debic Whipping</h5>
                    <p class="card-text">วิปปิ้งครีม Debic Whipping Cream เดบิค วิปปิ้งครีม 1L 205 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/wripping/millac.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Millac Gold</h5>
                    <p class="card-text">วิปปิ้งครีม Millac Gold 1L 160 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/wripping/president.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">President Whipping Cream</h5>
                    <p class="card-text">วิปปิ้งครีม President Whipping Cream 1L 285 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/wripping/rich gold.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Rich's Gold<Label></Label></h5>
                    <p class="card-text">ริชส์ วิป ทอปปิ้ง โกลด์ เลเบล 907g 185 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/wripping/rich sun.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Rich's Sun</h5>
                    <p class="card-text">ริชส์ ซันวิป 1KL 140 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/wripping/ตาตัว.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Tatua Whipping Cream Spray</h5>
                    <p class="card-text">ตาตัว วิปครีม สเปรย์ 400g 160 บาท</p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
        ...
        <div class="col-sm-1 col-md-3 col-lg-3">
            <div class="card">
                <img src="assets/img/wripping/แอลเลเวียร์.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Elle&Vire Excellence</h5>
                    <p class="card-text">แอลเลเวียร์ วิปปิ้งครีม 1L 285 บาท </p>
                    <a href="../projectYummy/order_confirmation.php" class="btn btn-outline-primary me-2">ใส่ตะกร้า</a>
                <a href="../projectYummy/order_confirmation.php" class="btn btn-primary">สั่งซื้อ</a>
                </div>
            </div>
